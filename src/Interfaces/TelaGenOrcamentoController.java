...
public class TelaGenOrcamentoController implements Initializable
{
    ...
    private void evtAdicionaProduto(ActionEvent event)
    {
        ...
        try
        {
            ...
            stage.showAndWait();
            if (TelaAddProdutoController.itemP != null)
            {
                //System.out.println(TelaAddProdutoController.itemP);
                tabelaProduto.getItems().add(TelaAddProdutoController.itemP);
            }
        } catch (Exception ex)
        {
    ...
    private void evtAdicionaServico(ActionEvent event)
    {
        ...
        try
        {
            ...
            stage.setMaximized(false);
            stage.showAndWait();
            if (TelaAddServicoController.item != null)
            {
                TabelaServico.getItems().add(TelaAddServicoController.item);
            }
        } catch (Exception ex)
        {
            System.out.println(ex.getMessage());
