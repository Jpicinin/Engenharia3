...
public class Orcamento
{
    ...
    {
        return "Orcamento{" + "codigo=" + codigo + ", dtorcamento=" + dtorcamento + ", dtvalidade=" + dtvalidade + ", total=" + total + ", obsformapagamento=" + obsformapagamento + ", usuarioid=" + usuarioid + ", cliente=" + cliente + ", produtosOrcamento=" + produtosOrcamento + ", servicosOrcamento=" + servicosOrcamento + '}';
    }
